    ...
    <footer className="relative bg-gray-900 text-white">
      ...
      <div className="relative container mx-auto px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Site Links */}
          <div className="text-center md:text-left relative left-12">
          ...
          {/* Contact Info */}
          <div  className="text-center md:text-left relative right-15">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                No: 209, Nethaji Road, Madurai, Tamil Nadu – 625001
              </li>
