...
export default function BankDetailsSection() {
  return (
    <section className="py-16 sm:py-20 bg-gray-100 overflow-hidden px-4 sm:px-6"> {/* Responsive padding */}
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 p-6 sm:p-8 rounded-3xl bg-white text-black shadow-lg"> {/* Responsive padding */}
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 p-6 rounded-lg space-y-4 border border-gray-200"> {/* Adjusted background */}
            <p className="text-base sm:text-lg"> {/* Responsive text */}
